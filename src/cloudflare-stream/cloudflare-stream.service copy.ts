...
export class CloudflareStreamService {
  ...
  // const urlWebhook = `https://api.cloudflare.com/client/v4/accounts/${this.accountId}/stream/webhooks`;

  // try {
  //   let response2 = await axios.put(urlWebhook, {
  //     "notificationUrl": "https://b66d-115-87-237-241.ngrok-free.app/webhook"
  //   }, config2);
  //   console.log(response2.data);
  // } catch (error) {
  //   console.error('Error:', error.response2 ? error.response2.data : error.message);
  // }
